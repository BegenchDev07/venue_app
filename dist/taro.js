...
const Image$1 = Object.assign({ src: NO_DEFAULT_VALUE, mode: singleQuote("scaleToFill"), "lazy-load": DEFAULT_FALSE, bindError: NO_DEFAULT_VALUE, bindLoad: NO_DEFAULT_VALUE }, touchEvents);
...
function getComponentsAlias$1(origin) {
  ...
  Object.keys(origin).sort((a, b) => {
    ...
    Object.keys(origin[key]).filter((attr) => !/^bind/.test(attr) && !["focus", "blur"].includes(attr)).sort().forEach((attr, index2) => {
...
const createTaroHook = (lifecycle) => {
  return (fn) => {
    const { R: React2, PageContext } = reactMeta;
...
const Taro = /* @__PURE__ */ getDefaultExportFromCjs(taroExports);
...
var reactReconciler_production_min = function $$$reconciler($$$hostConfig) {
      ...
      do {
        ...
        if ((d & p2) === p2) {
          ...
          B2 = {
            ...
            callback: h.callback,
            next: null
          }, null === n2 ? (l2 = n2 = B2, k2 = t2) : n2 = n2.next = B2, g |= p2;
        h = h.next;
        if (null === h)
  ...
  function hf(a, b, c) {
    ...
    null === b ? (b = {
      lastEffect: null,
      stores: null
    }, K2.updateQueue = b, b.stores = [a]) : (c = b.stores, null === c ? b.stores = [a] : c.push(a));
  }
  function gf(a, b, c, d) {
    b.value = c;
    b.getSnapshot = d;
  ...
  function ff(a, b, c, d) {
    ...
    null === b ? (b = {
      lastEffect: null,
      stores: null
    }, K2.updateQueue = b, b.lastEffect = a.next = a) : (c = b.lastEffect, null === c ? b.lastEffect = a.next = a : (d = c.next, c.next = a, a.next = d, b.lastEffect = a));
    return a;
  }
  function nf() {
  ...
  function Zf(a, b, c) {
    ...
    if ("hidden" === d.mode) {
      if (0 === (b.mode & 1))
        ...
        if (0 === (c & 1073741824))
          return a = null !== f2 ? f2.baseLanes | c : c, b.lanes = b.childLanes = 1073741824, b.memoizedState = {
            baseLanes: a,
            cachePool: null,
            transitions: null
          }, b.updateQueue = null, v2($f, ag), ag |= a, null;
        b.memoizedState = {
          baseLanes: 0,
          cachePool: null,
          transitions: null
  ...
  function jg(a, b, c) {
    ...
    if (null === a) {
      ...
      return f2 ? (d = b.mode, f2 = b.child, g = {
        mode: "hidden",
        children: g
      }, 0 === (d & 1) && null !== f2 ? (f2.childLanes = 0, f2.pendingProps = g) : f2 = kg(g, d, 0, null), a = ue(a, d, c, null), f2.return = b, a.return = b, f2.sibling = a, b.child = f2, b.child.memoizedState = ig(c), b.memoizedState = hg, a) : lg(b, g);
    }
    e = a.memoizedState;
  ...
  function mg(a, b, c, d, e, f2, g) {
    ...
    if (Kb(e))
      return d = Lb(e).digest, f2 = Error(m2(419)), d = Gf(f2, d, void 0), ng(a, b, g, d);
    c = 0 !== (g & a.childLanes);
    if (G2 || c) {
      d = O2;
      if (null !== d) {
        ...
        0 !== e && e !== f2.retryLane && (f2.retryLane = e, Td(a, e), ge(d, a, e, -1));
      }
      og();
      d = Gf(Error(m2(421)));
      return ng(a, b, g, d);
...
const Reconciler = /* @__PURE__ */ getDefaultExportFromCjs(reactReconciler_production_min);
var constants = {
  exports: {}
};
...
function setEvent(dom, name, value, oldValue) {
  ...
  if (isFunction(value)) {
    if (oldValue) {
      ...
      dom.addEventListener(eventName, value, "mini" !== PLATFORM_TYPE.HARMONY ? { isCapture, sideEffect: false } : void 0);
    } else {
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f = react_production_min, k = Symbol.for("react.element"), l = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, n = f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p = {
  key: true,
  ref: true,
  __self: true,
  __source: true
